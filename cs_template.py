...
def main():
    module = AnsibleModule(
        argument_spec = dict(
            ...
            hypervisor = dict(required=True, choices=[ 'KVM', 'VMware', 'BareMetal', 'XenServer', 'LXC', 'HyperV', 'UCS', 'OVM' ]),
            ...
            format = dict(default=None, choices=['QCOW2', 'RAW', 'VHD', 'OVA']),
